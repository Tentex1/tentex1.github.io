const translations = {
    tr: {
        ...
        "about-desc": "2010 yılında doğdum. Ufak yaşlarda bilgisayarlarla başlayan tutkum, beni şu an severek okuduğum bilişim lisesine kadar getirdi.<br><br>Kendimi ağırlıklı olarak <strong>.NET ekosisteminde</strong> geliştiriyorum. C# kullanarak desktop ve mobil projeler üretiyorum; <strong>WPF, WinForms ve MAUI</strong> aktif olarak kullandığım teknolojiler. İşin içinde C# ve XAML olduktan sonra, <strong>WinUI</strong> tarafına geçiş yapmak da benim için çocuk oyuncağı!<br><br>Veritabanı tarafında ise okulda öğretilen klasik T-SQL ve yerel SQL Server (.mdf) yapılarının yanında, projelerimde hafiflik sağlayan <strong>SQLite</strong> ve modern bulut çözümü olan <strong>Supabase</strong>'i harmanlamayı seviyorum.",        "hero-desc": "<br>🚀 <strong>Yazılım Geliştirici & Açık Kaynak Katkıcısı</strong><br><br>Bilişim lisesinde eğitim gören ve <strong>.NET ekosistemine</strong> odaklanmış tutkulu bir yazılımcıyım. <strong>C# & XAML</strong> kullanarak modern masaüstü ve mobil deneyimler geliştiriyor, yeni nesil arayüz kütüphaneleri ve bulut çözümleriyle çalışıyorum.",        "skill-dotnet": ".NET Ekosistemi & Framework'ler",
        "skills-title": "🛠️ Teknolojiler & Beceriler",
    ...
    en: {
        ...
        "hero-desc": "<br>🚀 <strong>Software Developer & Open Source Contributor</strong><br><br>I am a passionate software developer currently attending a computer science high school, with a focus on the <strong>.NET ecosystem</strong>. I develop modern desktop and mobile experiences using <strong>C# and XAML</strong>, and work with next-generation UI libraries and cloud solutions.",
