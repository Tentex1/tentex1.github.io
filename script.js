const translations = {
    tr: {
        ...
        "about-desc": "Benim adım Duran. \"Tentex\" olarak da biliniyorum. Masaüstü uygulamaları geliştirmeye odaklanan ve Android ekosistemini keşfeden tutkulu bir yazılımcıyım. C# kullanarak .NET ekosisteminde (MAUI, WinForms, WPF vb.) cross-platform (masaüstü & mobil) projeler geliştiriyorum. Şu sıralar modern arayüz (UI) kütüphanelerine ve açık kaynak dünyasına derinlemesine dalıyorum.",
        "skills-title": "🛠️ Teknolojiler & Yetenekler",
        "skill-dotnet": ".NET Ekosistemi & Framework'ler",
    ...
    en: {
        ...
        "hero-desc": "🚀 <strong>Software Developer & Open Source Contributor</strong><br><br>I am a passionate software developer focused on desktop application development and exploring the Android ecosystem. Currently, I am specializing in C# and modern UI libraries.",
        "hero-btn": "See My Projects",
        "projects-title": "My Projects",
        "projects-loading": "Loading projects from GitHub...",
        "about-title": "About Me",
        "about-desc": "My name is Duran, also known as \"Tentex\". I am a passionate software developer focused on desktop application development and exploring the Android ecosystem. I develop cross-platform (desktop & mobile) projects in the .NET ecosystem (MAUI, WinForms, WPF, etc.) using C#. Currently, I am deep diving into modern UI libraries and the open-source world.",
